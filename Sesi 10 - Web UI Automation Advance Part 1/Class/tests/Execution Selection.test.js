...
//         it('should login with valid credentials standard', async () => { //synatx only,only run
...
//         it('should login with valid credentials visual', async () => { //not run because doesn't give, if syntax only eraser in all it will run all progams
...
//         it.skip('should login with valid credentials glitch', async () => { // not run because give skip note only run
...
//     it('[Regression] should login with valid credentials glitch', async () => { // not run because give skip note only run

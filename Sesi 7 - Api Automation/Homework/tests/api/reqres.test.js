...
// import fetch from "node-fetch";
import Ajv from "ajv";
import schemas from "../schema/regresSchema.js";
...
describe("API Tests Suite", function () {
    ...
    //    validasi schema ajv
        const ajv = new Ajv();
        const validate = ajv.compile(schemas.schema_createuser); 
        const hasilcomparasi = validate(hasil);
        expect(hasilcomparasi, 'validasi schema ajv ada yang salah').to.be.true;
    });    
